...
<div class="login-clean" style="height:634.2px;padding-top:38px;">
    ...
    <h1 style="text-align:center;margin-left:0px;color:rgba(43,98,182,0.76);font-size:19px;text-transform:uppercase;">
...
?>
        <input class="form-control" type="text" name="username" placeholder="User name" autocomplete="on"
    ...
    <a class="text-primary forgot" href="<?php echo base_url("users/recovery/admin"); ?>">Forgot your email or password?&nbsp;
    <a class="text-primary forgot" href="<?php echo base_url("/"); ?>">Go back&nbsp;</a></form>
</div>
<footer>
