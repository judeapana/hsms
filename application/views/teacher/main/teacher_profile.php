...
<div class="container profile profile-view" id="profile">
    ...
    <div class="form-row profile-row">
        <div class="col-md-4  ">
            <div class="">
                <div class="">
                    <?php if (!empty($this->session->userdata("profileimg"))) { ?>
                        <img width="200" height="200" class=" img-thumbnail" src="<?php echo base_url(); ?>assets/images/users/teachers/<?php echo $this->session->userdata('profileimg'); ?>"/>
                    <?php } else { ?>
            ...
            <?php echo form_open_multipart("profile_teacher/uploadimg"); ?>
            <div class="col-md-12  ">
        ...
        <div class="col-md-8 col-sm-12">
            ...
            <div class="form-row">
                <div class="col-sm-12 col-md-6">
                    <?php echo form_open_multipart("profile_teacher"); ?>
                    <div class="form-group"><label>Firstname </label><input disabled="" class="form-control" type="text" name="fname"  value="<?php echo $results[0]['fname']; ?>"></div>
                    <p class="text-danger"><?php echo form_error("fname"); ?></p>
                </div>
                <div class="col-sm-12 col-md-6">
                    <div class="form-group"><label>Lastname </label><input disabled="" class="form-control" type="text" name="lname"  value="<?php echo $results[0]['lname']; ?>"></div>
            ...
            <div class="form-row">
                <div class="col-sm-12 col-md-6">
                    ...
                    <p class="text-muted"><?php echo form_error("pass"); ?></p>
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="form-group"><label>Confirm Change Password</label><input class="form-control" type="password" name="cpass" autocomplete="off"  >
                        <p class="text-danger"><?php echo form_error("cpass"); ?></p>
