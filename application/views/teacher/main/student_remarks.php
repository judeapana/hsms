    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
                <h4 class="page-title">Student Behaviour / Remarks</h4>
            ...
            <div class="col-md-8 col-sm-12">
                <div class="card">
                    <div class="form-horizontal">
                        <div class="card-body">
                            <h4 class="card-title">Remarks <a href="" class="" title="things you should now" data-toggle="modal" data-target="#Modal1"><span class="mdi mdi-comment-question-outline"></span></a></h4>

                            <hr>
                            <!-- Col-->
                            <?php echo form_open("student_remarks"); ?>
                            <div class="row" >
                                <div class="col-md-6 col-sm-12"><div class="form-group row">
                                        <label class="col-md-4 m-t-5">Student ID</label>
                                        <div class="col-md-9" data-select2-id="11">
                                            <select name="stdid" class="select2 form-control custom-select select2-hidden-accessible" style="width: 100%; height:36px;" data-select2-id="1" tabindex="-1" aria-hidden="true" value="<?php echo set_value("stdid"); ?>">
                                                <option selected disabled data-select2-id="3">Search and Select ID</option>                                         
                                                <?php foreach ($stdids as $rows) { ?>                                         
                                                    <option  value="<?php echo $rows["stdid"]; ?>"><?php echo $rows['stdid']; ?></option>                
                                                <?php } ?>
                                ...
                                <div class="col-md-6 col-sm-12"><div class="form-group row">
                                        <label class="col-md-4 m-t-5">Form</label>
                            ...
                            <div class="row p-t-10" >
                                ...
                                <div class="col-md-6 col-sm-12"><div class="form-group row">
                                        <label class="col-md-4 m-t-5">Semester</label>
                            ...
                            <div class="col-md-6 col-sm-12 ">
                                <div class="form-group row">
                                    <label class="col-md-4 m-t-5">Academic Year</label>
                            ...
                            <div class="col-md-12 col-sm-12 text-center"> 
                                <button type="submit" class="btn btn-primary btn pull-right"><span class="mdi mdi-download"> Insert Remarks</span></button>
                            </div>
                            <?php echo form_close(); ?>
                        </div>
                    </div>
