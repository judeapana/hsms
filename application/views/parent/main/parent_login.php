    ...
    <body style="background-color:#282d32;height:723px;">
        <div class="login-clean" style="height:634.2px;padding-top:38px;">
           <?php echo form_open();?>
                ...
                <h1 style="text-align:center;margin-left:0px;color:rgba(43,98,182,0.76);font-size:19px;text-transform:uppercase;"><strong>Parent</strong></h1>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" disabled="" type="text" name="username"  placeholder="Service Not Available"autocomplete="on" value="<?php echo set_value("username"); ?>">
                </div>
                <div class="form-group">
                    <small class="form-text text-muted" style="margin-bottom:8px;text-align:center;color:#f28411 !important;">
                        <strong><?php echo form_error("password")?></strong></small>
                    <input  disabled="" class="form-control" type="password" name="password"  placeholder= "Service Not Available" >
                  
                </div>
                
                <div class="form-group"><button class="btn btn-primary btn-block" type="submit">Log In</button></div><a class="text-primary forgot" href="<?php echo base_url("users/recovery/parent")?>">Forgot your email or password?&nbsp;<i class="fa fa-link"></i></a></form>
        </div>
        <footer>
