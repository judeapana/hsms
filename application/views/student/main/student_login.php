    ...
    <body style="background-color:#282d32;height:723px;">
        <div id="fakeLoader-student"></div>
        <div class="login-clean" style="height:634.2px;padding-top:38px;">
           <?php echo form_open(); ?>
                <h2 class="sr-only">Login Form</h2>
                <h1 style="text-align:center;margin-left:0px;color:rgba(43,98,182,0.76);font-size:19px;text-transform:uppercase;"><strong>Student</strong></h1>
...
if ($error) {
	echo '<small class="form-text text-muted" style="margin-bottom:8px;text-align:center;color:#f28411 !important;">
                ...
                <div class="form-group"><button class="btn btn-primary btn-block" type="submit">Log In</button></div><a class="text-primary forgot" href="<?php echo base_url("users/recovery/student"); ?>">Forgot your email or password?&nbsp;<i class="fa fa-link"></i></a>
