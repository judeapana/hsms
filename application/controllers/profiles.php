...
class profiles extends CI_Controller
{
    ...
    public function index($option)
    {
        ...
        $data['results'] = $this->profile->view('administrators', $array);
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            if ($this->profile->update($array, $data_login, 'users')) {
                ...
                redirect('profiles/administrators');
            }
        } else {


            $this->load->view('admin/main/' . $option . '_profile', $data);
        }
    }
    ...
    public function uploadimg()
    {
        ...
        if ($this->upload->do_upload('profileimg') == TRUE) {
            ...
            if ($this->profile->update($id, $data, 'administrators')) {
